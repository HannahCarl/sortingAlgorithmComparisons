/*Hannah Posch
* HW 8, Summer 2018
* The code in this file will sort arrays using 5 different algorithms: insertion sort, heap sort, merge sort, quick sort,
* and quick sort 2. The methods will be used in another file to compute the time it takes for each algorithm to sort
...
public final class Sort
{
   ...
   /****************** HEAPSORT ***************************
    ...
    /************************ QUICKSORT 2 *******************
     * Quick Sort 2 (public):
     * The method uses a helper private function to complete the sort.
     * @param a an array of Comparable items.
     */
    public static <AnyType extends Comparable<? super AnyType>>
    ...
    /**
     * Quick Sort 2 (private):
     * Internal quicksort method that makes recursive calls.
     * Uses the last element as the pivot and continues to recursively call itself
     * to sort the items.
     * @param a an array of Comparable items.
     * @param left the left-most index of the subarray.
     * @param right the right-most index of the subarray.
